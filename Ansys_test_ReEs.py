...
policy_net = Re_Es(18, 354, hidden_dim=128).to(device)

state_dict = torch.load('./Agents/SequentialFuselageActuators__NN_SequentialFuselageActuators__1__1744199521.pth',map_location=device)
policy_net.eval()
